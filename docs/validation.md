...
to two 24-unit coherence windows, then exchanged continuously. These images expose both
the former long-time concentric-ring failure and any discontinuity at field renewal. The
GPU clock additionally wraps only after the complete `24 × 97 = 2,328`-unit seed cycle;
